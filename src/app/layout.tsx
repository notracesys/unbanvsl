...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        {/* Favicon e metas básicos são injetados automaticamente pelo Next.js */}
      </head>
      <body>
