...
export default function SearchPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0B1020] relative text-[#F5F7FB] font-sans selection:bg-[#4DA3FF]/30 overflow-x-hidden">
      ...
      {/* Header / Logo */}
      <nav className="relative z-10 w-full pt-8 pb-4 flex justify-center px-6">
      ...
      <main className="flex-1 relative z-10 flex flex-col items-center px-6 pt-2 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="w-full max-w-[420px] flex flex-col items-center text-center">
          ...
          {/* 1. Badge no topo */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#161F38]/80 border border-[#4DA3FF]/20 mb-8 shadow-sm">
          ...
          <h1 className="text-3xl md:text-4xl font-bold leading-[1.1] tracking-tight mb-6 px-2 text-balance">
          ...
          {/* 3. Subheadline */}
          <p className="text-[15px] text-[#AAB4D0] mb-10 leading-relaxed px-2 font-medium">
          ...
          <div className="w-full space-y-8">
            <div className="space-y-4">
              ...
              <div className="relative group">
                <div className="absolute -inset-[2px] bg-gradient-to-r from-[#4DA3FF]/40 to-[#4DA3FF]/5 rounded-[2rem] blur-[2px] opacity-50 group-focus-within:opacity-100 transition duration-500" />
                <div className="relative flex items-center">
                  <div className="absolute left-6 w-5 h-5 flex items-center justify-center pointer-events-none">
                  ...
                  <input 
                    ...
                    className="w-full h-18 bg-[#0D1428] border border-[#27314F] rounded-[1.8rem] pl-16 pr-6 text-[16px] focus:outline-none focus:ring-2 focus:ring-[#4DA3FF]/40 transition-all placeholder:text-[#AAB4D0]/30 shadow-[inset_0_2px_15px_rgba(0,0,0,0.6)]"
                  />
                </div>
              </div>
            </div>
            ...
            <Button 
              ...
              className="w-full h-18 rounded-[1.8rem] bg-[#4DA3FF] hover:bg-[#3d8be0] text-[#0B1020] font-black text-sm uppercase tracking-[0.2em] shadow-[0_12px_40px_rgba(77,163,255,0.3)] active:scale-[0.98] transition-all"
            >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-[10px] font-bold text-[#AAB4D0]/40 uppercase tracking-widest text-center px-4">
            <span>Consulta sobre seus próprios dados</span>
            <div className="w-1 h-1 bg-[#27314F] rounded-full" />
          ...
          {/* 6. Branding de dados */}
          <div className="mt-12 pt-8 border-t border-[#27314F]/30 w-full flex flex-col items-center gap-4">
      ...
      <footer className="relative z-10 w-full py-8">
        {/* Footer icons removed as requested */}
      </footer>
